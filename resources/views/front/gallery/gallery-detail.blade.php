        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">Galeri Foto & Video</a></li>
                    <li class="breadcrumb-item text-white" aria-current="page">{{ $media->post_title }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s">
                <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius">
                    Galeri Foto</h4>
                <h1 class="mb-5 display-4">{{ $media->post_title }}</h1>
                <div class="container-full">
                    <p style="text-align:center;">by {{ $user }} -
                        {{ \Carbon\Carbon::parse($media->created_at)->translatedFormat('l, d F Y') }}</p>
                    <div class="top-link d-flex gap-3 pe-2"
                        ...
                        <!-- Share to Twitter -->
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($media->post_title) }}&url={{ urlencode(request()->fullUrl()) }}"
                            class="btn btn-secondary btn-sm-square rounded-circle"><i
                                class="fab fa-twitter text-white fa-lg"></i></a>
                        <!-- Share to Whatsapp -->
                        <a href="https://wa.me/?text={{ urlencode($media->post_title . ' ' . request()->fullUrl()) }}"
                            class ="btn btn-secondary btn-sm-square rounded-circle"><i
            ...
            <div class="row g-5 justify-content-center">
                ...
                <div class="container justify">
                    <p style="text-align:center; font-size:110%;">{!! $media->post_desc !!}</p>
                </div>
            </div>
        </div>
    </div>

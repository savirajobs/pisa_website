...
<main id="main" class="main">
	<div class="pagetitle">
		<h1>{{ __('Content Management | Gallery') }}</h1>
		<nav>
			<ol class="breadcrumb">
				...
				<div class="card-body">
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="pills-foto-tab" data-bs-toggle="pill"
								data-bs-target="#pills-foto" type="button" role="tab"
								aria-controls="pills-foto" aria-selected="true">Foto</button>
						</li>
						<li class="nav-item" role="presentation">
					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-foto" role="tabpanel"
							...
							<h5 class="card-title">
								<button class="btn btn-primary btn-sm add-btn" data-bs-toggle="modal"
									data-bs-target="#modal-add-gallery"><i class="bi bi-window-plus"></i> Add Gallery Foto</button>
							</h5>
						...
						<div class="tab-pane fade" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab"
							...
							<h5 class="card-title">
								<button class="btn btn-primary btn-sm add-btn" data-bs-toggle="modal"
									data-bs-target="#modal-add-video"><i class="bi bi-window-plus"></i> Add Gallery Video</button>
							</h5>
